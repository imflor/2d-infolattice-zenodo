"""
==============================================================================================
Data for Fig. 13 (Section IV.C) — Information lattice of the toric code with twist defects
==============================================================================================
...
-------------------
data : dict[str]
    Contains the information lattice the toric code ground state with a pair of twist defects.

Keys for each dataset label
---------------------------
name : str
    Dataset label ("twist_defects_toric_code").
...
## Input data
data = np.load("fig13.npy", allow_pickle=True).item(0)
